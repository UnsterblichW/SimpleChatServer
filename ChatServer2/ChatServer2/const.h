...
public:
	// 接受一个lambda表达式或者函数指针
	DeferFuncWapper(std::function<void()> func) : func_(func) {}
...
constexpr auto USER_IP_PREFIX = "uip_";
constexpr auto USER_TOKEN_PREFIX = "utoken_";
constexpr auto IP_COUNT_PREFIX = "ipcount_";
